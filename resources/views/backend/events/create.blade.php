            ...
            <div class="box-body">
              ...
              @endif              
                ...
                <div class="form-group" style="margin-top:10px;margin-bottom:10px">
                    ...
                    <div class="col-md-9">
                        <img id="thumbnail_image"
                             src="{{ old('small_banner') ? Helper::showImage(old('small_banner')) : asset('backend/dist/img/img.png') }}"
                             class="img-thumbnail" width="145" height="85">
                        <button class="btn btn-default btn-sm btnSingleUpload" data-set="small_banner"
                                data-image="thumbnail_image" type="button"><span
                                class="glyphicon glyphicon-upload" aria-hidden="true"></span> Upload
                        </button>
                        <input type="hidden" name="small_banner" id="small_banner"
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control datetime" autocomplete="off" name="from_date" id="from_date" value="{{ old('from_date') }}">
                </div>
                <div class="form-group">
                  <label>Ngày kết thúc</label>
                  <input type="text" class="form-control datetime" autocomplete="off" name="to_date" id="to_date" value="{{ old('to_date') }}">
                </div>
            </div>
            <!-- /.box-body -->
