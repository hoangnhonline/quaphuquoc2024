              ...
              @endif              
               <div class="form-group" style="margin-top:10px;margin-bottom:10px">
                ...
                <div class="form-group">
                  <label>Text nhỏ</label>
                  <input type="text" name="small_text" id="small_text" value="{{ old('small_text') }}" class="form-control">
                </div>
                <div class="form-group">
                  <label>Text lớn</label>
                  <input type="text" name="large_text" id="large_text" value="{{ old('large_text') }}" class="form-control">
                </div>
                <div class="form-group">
                  <label>Ẩn / Hiện</label>
