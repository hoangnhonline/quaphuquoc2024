            ...
            <div class="box-body">
              ...
              @endif              
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="small_text" id="small_text" value="{{ old('small_text', $detail->small_text) }}" class="form-control">
                </div>
                <div class="form-group">
                  <label>Text lớn</label>
                  <input type="text" name="large_text" id="large_text" value="{{ old('large_text', $detail->large_text) }}" class="form-control">
                </div> 
                <div class="form-group">
                  <label>Ẩn / Hiện</label>
