...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('cate-child.index') }}">Danh mục cấp 1</a></li>
    ...
    <div class="row">
      ...
      <div class="col-md-7">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" method="POST" action="{{ route('cate-child.update') }}">
            {!! csrf_field() !!}
              ...
              @endif
               <div class="form-group">
                  ...
                  <select class="form-control select2" name="cate_id" id="cate_id">                  
                    <option value="0" {{ $detail->cate_id == 0 ? "selected" : "" }}>--Chọn--</option>
