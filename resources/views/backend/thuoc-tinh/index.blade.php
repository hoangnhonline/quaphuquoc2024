...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      @endif
      <a href="{{ route('thuoc-tinh.create') }}?parent_id={{ $parent_id }}&loai_thuoc_tinh_id={{ $loai_thuoc_tinh_id }}" class="btn btn-info" style="margin-bottom:5px">Tạo mới</a>
          ...
          <form class="form-inline" role="form" method="GET" action="{{ route('thuoc-tinh.index') }}" id="searchForm">
            <div class="form-group">
              ...
              <select class="form-control" name="parent_id" id="parent_id">
                ...
                <option value="{{ $k }}" {{ $k == $parent_id ? "selected" : "" }}>{{ $v }}</option>
                @endforeach
              </select>
            </div>
            <div class="form-group">
