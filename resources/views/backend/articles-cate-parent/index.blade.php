...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ route( 'articles-cate-parent.index' ) }}">Danh mục</a></li>
...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      @endif
      <a href="{{ route('articles-cate-parent.create') }}" class="btn btn-info" style="margin-bottom:5px">Tạo mới</a>
      <div class="box">
          ...
          <table class="table table-bordered" id="table-list-data">
            ...
            @if( $items->count() > 0 )
              ...
              <tr id="row-{{ $item->id }}">
                ...
                <td>                  
                  <a href="{{ route( 'articles-cate-parent.edit', [ 'id' => $item->id ]) }}">{{ $item->name }}</a>
                ...
                <a class="btn btn-default btn-sm" href="{{ route('news-list', $item->slug ) }}" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i> Xem</a>
                  ...
                  <a href="{{ route( 'articles-cate-parent.edit', [ 'id' => $item->id ]) }}" class="btn btn-warning">Chỉnh sửa</a>                 
                  @if( $item->articles->count() == 0)
                  <a onclick="return callDelete('{{ $item->name }}','{{ route( 'articles-cate-parent.destroy', [ 'id' => $item->id ]) }}');" class="btn btn-danger">Xóa</a>
                  @endif
                </td>
              </tr> 
              @endforeach
