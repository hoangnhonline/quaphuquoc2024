    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-default">       
        <div class="panel-body">
          <form class="form-inline" role="form" method="GET" action="{{ route('articles-cate.index') }}" id="formSearch">
      ...
      <div class="box">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">Danh sách ({{ $items->count() }} mục)</h3>
        </div>
