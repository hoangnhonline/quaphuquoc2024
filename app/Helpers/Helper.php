...
class Helper
{
    ...
    public static function showImage($image_url, $type = 'original'){
        ...
        //return strpos($image_url, 'http') === false ? config('gfamily.upload_url') . $type . '/' . $image_url : $image_url;        
        return strpos($image_url, 'http') === false ? env('APP_URL', 'http://gfamily.vn') . $image_url : $image_url;   
    ...
    public static function uploadPhoto($file, $base_folder = '', $date_dir=false){
        ...
        $desPath = config('gfamily.upload_path'). $basePath;
