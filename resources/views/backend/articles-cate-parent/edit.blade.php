...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('articles-cate-parent.index') }}">Danh mục bài viết</a></li>
  ...
  <section class="content">
    <a class="btn btn-default" href="{{ route('articles-cate-parent.index') }}" style="margin-bottom:5px">Quay lại</a>
    ...
    <div class="row">
      ...
      <div class="col-md-7">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" method="POST" action="{{ route('articles-cate-parent.update') }}">
            {!! csrf_field() !!}
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default" class="btn btn-primary" href="{{ route('articles-cate-parent.index')}}">Hủy</a>
            </div>
