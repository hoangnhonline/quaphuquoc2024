...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <a class="btn btn-primary btn-sm" href="{{ route('fe-parent-cate', $detail->slug ) }}" target="_blank" style="margin-top:-6px"><i class="fa fa-eye" aria-hidden="true"></i> Xem</a>
            ...
            <div class="box-body">
              ...
              @endif                
                ...
                <div class="form-group" style="margin-top:10px;margin-bottom:10px">
                    <label class="col-md-3 row">Thumbnail ( 540 x 360px)</label>
                    <div class="col-md-9">
          ...
          <!-- /.box-header -->
            <div class="box-body">
              <div class="form-group">
                ...
                <input type="text" class="form-control" autocomplete="off" name="meta_title" id="meta_title" value="{{ $detail->meta_title }}">
              </div>
              <!-- textarea -->
              <div class="form-group">
