...
(function($) {
	...
	*===================================*/
	...
	/*===================================*
	21. QUICKVIEW POPUP + ZOOM IMAGE + PRODUCT SLIDER JS //bo tinh nang zoom
	*===================================*/
	...
	$('.product_img_zoom').on('click', function(){
		var atual = $('#pr_item_gallery a.active').attr('data-zoom-image');
	...
	*===================================*/
	...
	function initialize() {
		var map;
		var panorama;
		var var_latitude = 16.066475; // Google Map Latitude
		var var_longitude = 108.184373; // Google Map Longitude
...
$(document).ready(function() {
    $('.btnMuaDetail').click(function() {
		...
		var amount = $('#quantity-product').val();
        add_product_to_cart(product_id, amount);
      });

	$('.btnMuaHome').click(function() {

        var product_id = $(this).attr('product-id');
        add_product_to_cart_from_home(product_id);
      });
...
function add_product_to_cart_from_home(product_id, amount) {
