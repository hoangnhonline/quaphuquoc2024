...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('cate-child.index') }}">Danh mục cấp 2</a></li>
  ...
  <section class="content">
    <a class="btn btn-default" href="{{ route('cate-child.index') }}" style="margin-bottom:5px">Quay lại</a>
    <form role="form" method="POST" action="{{ route('cate-child.store') }}">
    <div class="row">
      <!-- left column -->
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
              ...
              @endif
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="cate_id" id="cate_id">                  
                    <option value="0" {{ old('cate_id', $cate_id) == 0 ? "selected" : "" }}>--chọn--</option>
                    @foreach( $cateArr as $value )
                    <option value="{{ $value->id }}" {{ ( old('cate_id', $cate_id) == $value->id) ? "selected" : "" }}>{{ $value->name }}</option>
                    @endforeach
                  </select>
                </div> 
                 <!-- text input -->
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default" class="btn btn-primary" href="{{ route('cate-child.index')}}">Hủy</a>
            </div>
