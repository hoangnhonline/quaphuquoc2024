          ...
          <table class="table table-bordered" id="table-list-data">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="{{ route( 'banner.index', [ 'object_id' => 3, 'object_type' => 3 ]) }}" class="link_edit">Baner khuyến mãi trang chủ</a></td>
                <td style="white-space:nowrap; text-align:right">                 
              ...
              <tr>
                ...
                <td><a href="{{ route( 'banner.index', [ 'object_id' => 4, 'object_type' => 3 ]) }}" class="link_edit">Banner phải phần tin tức</a></td>
                <td style="white-space:nowrap; text-align:right">                 
