        ...
        <div class="panel-body">
          <form class="form-inline" id="formSearchAjax" role="form" method="GET" action="{{ route('product.ajax-search') }}">
            ...
            <div class="form-group">
              <label for="email">Danh mục chính</label>
              <select class="form-control" name="parent_id" id="parent_id_search">
              ...
              <div class="form-group">
              <label for="email">Danh mục cấp 1</label>
      ...
      <div class="box">
        ...
        <div class="box-body">          
          <table class="table table-bordered" id="table-list-data">
            ...
            @else
            <tr>
              <td colspan="9">{{ $arrSearch['parent_id'] == -1 ? "Vui lòng chọn danh mục để lọc" :  "Không có dữ liệu." }}</td>
            </tr>
            @endif
