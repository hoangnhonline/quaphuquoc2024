...
<head>
  ...
  <title>GFAMILY.VN | Dashboard</title>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{ URL::asset('backend/dist/css/AdminLTE.css?ver=1.1') }}">
...
@include('backend.customer.customer-notification-modal')
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021-2025 <a href="mailto:hoangnhonline@gmail.com">hoangnhonline@gmail.com</a>.</strong> All rights
    reserved.
  </footer>

  <!-- Add the sidebar's background. This div must be placed
       immediately after the control sidebar -->
<input type="hidden" id="upload_url" value="{{ config('gfamily.upload_url') }}">
...
<input type="hidden" id="url_open_kc_finder" value="{{ asset('backend/dist/js/kcfinder/browse.php?type=images') }}">
<input type="hidden" id="url_open_kc_finder_video" value="{{ asset('backend/dist/js/kcfinder/browse.php?type=videos') }}">
<input type="hidden" id="url_open_kc_finder_music" value="{{ asset('backend/dist/js/kcfinder/browse.php?type=musics') }}">
...
<script src="{{ URL::asset('backend/dist/js/pages/dashboard.js?ver=1.2') }}"></script>
...
<script src="{{ asset('backend/dist/js/number.js') }}"></script>
