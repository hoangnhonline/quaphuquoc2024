...
<section class="content-header">
  <h1>
    Danh mục cấp 1 của : <span class="cate-name">{{ $productCate->name }}</span>
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
    <li><a href="{{ route( 'cate.index' ) }}">Danh mục chính</a></li>
              ...
              <?php $i = 0; ?>
                @foreach( $items as $item )
                  ...
                  @endif
                    ...
                    <td style="text-align:center;"><a style="font-size: 19px; font-weight: bold;" href="{{ route('cate-child.index', [$item->id])}}">{{ $item->cateChild->count() }}</a></td>
                    <td style="text-align:center;"><a style="font-size: 19px; font-weight: bold;"  href="{{ route('cate.index', [$item->id])}}">{{ $item->products->count() }}</a></td>                           
                   
                    <td style="white-space:nowrap; text-align:right">
                      <a class="btn btn-default btn-sm" href="{{ route('fe-cate', [$productCate->slug, $item->slug] ) }}" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i> Xem</a>
